    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-bold text-2xl text-purple-800 leading-tight">
                {{ __('Editar Categoria de Contato') }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-2xl">
                <div class="p-8">
                    ...
                    <form action="{{ route('tipocontatos.update', $tipocontato->id) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="descricao" id="descricao" rows="5"
                                class="w-full px-4 py-3 rounded-xl border-2 border-purple-200 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 transition-all duration-300">{{ old('descricao', $tipocontato->descricao) }}</textarea>
                        ...
                        <div class="flex items-center justify-between pt-6">
                            ...
                            <button type="submit"
                                class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
